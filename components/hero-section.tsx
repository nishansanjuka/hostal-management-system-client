...
export default function HeroSection() {
  ...
  return (
    <Fragment>
      <section className="relative w-full xl:h-screen hidden sm:block xl:hidden">
        {!hideSky && (
          <Image
            // style={{ scale: 1.5 - scrollY / 800 }}
            className=" object-contain fixed top-0 left-0"
            src={ImgSky}
            alt="ImgSky"
          />
        )}
        <div className=" relative flex justify-center overflow-hidden">
          <Image className="object-contain" src={Mountains} alt="ImgSky" />
          {!hideSky && (
          ...
          <Image
            ...
            className="object-contain absolute left-0 top-0 right-0 bottom-0 xl:bottom-40"
            src={Ground}
            alt="ImgSky"
          />
          <Image
            style={{ scale: 1 + scrollY / 1000 }}
            className="object-contain absolute w-[60%] xl:w-[50%] bottom-0 xl:bottom-20"
            src={Students}
            alt="ImgSky"
          />
        </div>
      </section>
      <div className=" w-full h-screen relative hidden xl:block overflow-hidden">
        {!hideSky && <Image src={ImgSky} alt="ad" className=" fixed  top-0" />}

        <Image src={Mountains} alt="ad" className=" absolute bottom-0" />
        {!hideSky && (
          <div className=" fixed top-[5%] xl:top-[20%] left-0 right-0 bottom-0 flex flex-col w-full items-center space-y-5">
            <h1 className=" font-extrabold text-4xl 2xl:text-7xl capitalize text-foreground">
              sample text Sample Simple text
        ...
        />
        <div className=" w-full absolute bottom-0 left-0 right-0 flex items-end justify-center">
          <Image
