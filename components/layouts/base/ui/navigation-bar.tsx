...
export const NavigationBar: FC = () => {
  ...
  useEffect(() => {
    const onScrolling = () => {
      ...
      setSetsecondaryNavigation(window.scrollY >= window.innerWidth * (9 / 16));
  ...
  return (
    <header
      className={cn(
        " z-50 flex items-center max-w-2560 h-fit  px-10 py-6 justify-center transition-colors duration-300",
        isHome ? "bg-transparent fixed w-[99vw]" : "bg-green-700 fixed w-full",
    ...
    >
      <Image
        alt="logo"
        src={isHome ? (!secondaryNavigation ? logoDark : logoLight) : logoLight}
      ...
      <Button
        ...
        className={cn(
          ...
          isHome ? "text-muted-foreground" : "text-white hover:text-green-600",
